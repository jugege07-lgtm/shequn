  ...
  <div class="phone-frame">
    ...
    <div class="header">
      <div class="header-left">
        ...
        <span class="header-title">会员商城</span>
      </div>
    ...
    <div class="main-scroll">
      ...
      <div class="points-coupon">
        ...
        <div class="coupon-card" @click="$router.push('/coupon/index')">
          <div class="card-title">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 12V8H6a2 2 0 01-2-2c0-1.1.9-2 2-2h12v4"/><path d="M4 6v12c0 1.1.9 2 2 2h14v-4"/><path d="M18 12a2 2 0 100-4 2 2 0 000 4z"/></svg>
            优惠券
          </div>
...
// 图片加载失败时回退到 emoji 占位
function onImgError(e: Event, p: any) {
...
.card-title svg { width: 14px; height: 14px; color: var(--color-text-tertiary); }
.card-value {
  font-size: 20px; font-weight: 800; color: var(--color-primary);
  display: flex; align-items: baseline; gap: 2px;
}
.card-value span { font-size: 12px; font-weight: 400; }
