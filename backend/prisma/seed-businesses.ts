...
const businesses = [
  {
    ...
    unlockFee: 0,
    maxUnlocks: 20,
    coverImage: '/uploads/biz_it_software.jpg',
  },
  {
    title: '品牌推广渠道对接',
    ...
    unlockFee: 19.9,
    maxUnlocks: 15,
    coverImage: '/uploads/biz_marketing.jpg',
  },
  {
    title: '投融资项目对接',
    ...
    unlockFee: 0,
    maxUnlocks: 10,
    coverImage: '/uploads/biz_finance.jpg',
  },
  {
    title: '在线教育招生合作',
    ...
    unlockFee: 29.9,
    maxUnlocks: 25,
    coverImage: '/uploads/biz_education.jpg',
  },
  {
    title: '医疗器械渠道合作',
    ...
    unlockFee: 0,
    maxUnlocks: 12,
    coverImage: '/uploads/biz_healthcare.jpg',
  },
  {
    title: '房产中介客户转介绍',
    ...
    unlockFee: 39.9,
    maxUnlocks: 8,
    coverImage: '/uploads/biz_realestate.jpg',
  },
  {
    title: '供应链采购对接',
    ...
    unlockFee: 0,
    maxUnlocks: 15,
    coverImage: '/uploads/biz_manufacturing.jpg',
  },
  {
    title: '电商运营资源对接',
    ...
    unlockFee: 49.9,
    maxUnlocks: 20,
    coverImage: '/uploads/biz_ecommerce.jpg',
  },
];
...
async function main() {
  ...
  // 4. 创建/更新商机记录（按标题判断，已存在则更新主图等字段，可重复执行）
  let created = 0;
  let updated = 0;
  let skipped = 0;
  for (const biz of businesses) {
    ...
    if (!exists) {
      await prisma.business.create({
        data: { ...data, title: biz.title, currentUnlocks: 0, publisherId: adminUser.id },
      });
  ...
  console.log(`\n本次新增 ${created} 条，更新主图 ${updated} 条，无需变更 ${skipped} 条。`);
